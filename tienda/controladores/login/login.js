...
/**1- Se debe asignar a la siguiente constante todo el código correspondiente al componente de login (/asset/modulos/login.html), ya está hecho!! */
const htmlLogin=
`
...
export async function login(){
     ...
     * 
    */
    crearFormulario();  /* debemos capturar el evento html del formulario cuando se presiona el boton submit   */
...
function crearFormulario(registrar){
     ...
     * 5- En el caso que el parámetro registrar sea falso deberá eliminar el contenido del elemento id reLoginPassword, con outher html borra 
     *  el contenido pero deja el bloque inteacto.
...
async function  ingresar(e){
    ...
    if(idUsuario){
        ...
        mostrarMensaje("email o contrasena incorrecto, por favor inténtelo de nuevo");
    };
}

async function  registrarUsuario(e){
    /** buscar en el proyecto anterior:
     * 
